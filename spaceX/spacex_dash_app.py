...
unique_values = spacex_df[['Launch Site']].value_counts().to_frame().reset_index()['Launch Site'].to_list()
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                [{'label': 'All Sites', 'value': 'ALL'}]+[{'label': site, 'value': site} for site in unique_values],
                                    placeholder='ALL',
                                    searchable=True
                                    ),
                                html.Br(),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df,values='count', 
            title=f'Success launches rate for {entered_site} site')
        return fig
# TASK 4:
